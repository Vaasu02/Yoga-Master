...
import img from '../../../src/assets/homeimg/yoga2.jpg'
          ...
          <div className='grid mb-28 md:grid-cols-2 lg:grid-cols-3 w-[90%] gap-4 mx-auto mt-20'>
            {
              instructors?.map((instructor, i) => (
                <div className='flex dark:text-white hover:-translate-y-2 duration-200 cursor-pointer flex-col shadow-md py-8 px-10 
                 rounded-md'>
                  <div className='flex-col flex gap-6 md:gap-8'>
                    ...
                    <div className='flex flex-col text-center'>
                      ...
                      <p className="text-gray-500 ">Address: {instructor?.address}</p>
