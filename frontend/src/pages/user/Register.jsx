        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="mb-4">
              ...
              <input type="password" placeholder='Photo URL' {...register("photoUrl")}
                className='w-full border-gray-300 border rounded-md py-2 px-4 focus:outline-none focus:ring focus:border-blue-300' />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mb-4">
              ...
              <textarea rows="3" {...register("address", { required: true })} className='w-full border border-gray-300 rounded-md py-2 px-4 focus:outline-none focus:ring focus:border-blue-300'></textarea>
